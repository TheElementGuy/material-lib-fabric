...
public class SandDiamondTypeBuilder extends MaterialConfigurationBuilder<SandDiamondTypeBuilder> {
	...
	@Override
	protected SandDiamondTypeBuilder self() {
		return this;
	}
	 ...
	 * @param oreBefore the block that the sand ore will be placed after, as a string (for example, "sand")
	 * @return the updated <code>MaterialConfigurationBuilder</code>
	 */
	public SandDiamondTypeBuilder setBefore(String toolsBefore, String armorBefore, Supplier<Item> itemBefore, Supplier<Block> blockBefore, String oreBefore) {
