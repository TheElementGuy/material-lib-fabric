 ...
 */
public class NetherDiamondTypeBuilder extends MaterialConfigurationBuilder<NetherDiamondTypeBuilder> {
	@Override
	protected NetherDiamondTypeBuilder self() {
		return this;
	}
	 ...
	 */
	public NetherDiamondTypeBuilder setBefore(String toolsBefore, String armorBefore, Supplier<Item> itemBefore, Supplier<Block> blockBefore, String oreBefore) {
