...
/**
 * Builder used to construct {@link EndIronTypeMaterialConfiguration}s. Create a new instance and call methods until ready to call <code>build()</code>.
 */
public class EndIronTypeBuilder extends MaterialConfigurationBuilder<EndIronTypeBuilder> {

	protected String RAW_BEFORE;

	@Override
	protected EndIronTypeBuilder self() {
		return this;
	}
	 ...
	 */
	public EndIronTypeBuilder setBefore(String toolsBefore, String armorBefore, Supplier<Item> itemBefore, Supplier<Block> blockBefore, String rawBefore, String oreBefore) {
