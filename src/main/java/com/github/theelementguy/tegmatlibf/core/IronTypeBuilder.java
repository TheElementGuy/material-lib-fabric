 ...
 */
public class IronTypeBuilder extends MaterialConfigurationBuilder<IronTypeBuilder> {

	protected String RAW_BEFORE;

	@Override
	protected IronTypeBuilder self() {
		return this;
	}
	 ...
	 */
	public IronTypeBuilder setBefore(String toolsBefore, String armorBefore, Supplier<Item> itemBefore, Supplier<Block> blockBefore, String rawBefore, String oreBefore) {
