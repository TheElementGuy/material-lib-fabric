...
/**
 * Subclass of {@link MaterialConfiguration} for diamond-type materials. Use the {@link DiamondTypeBuilder} for construction.
...
public class DiamondTypeMaterialConfiguration extends MaterialConfiguration {
	...
	public List<Block> getBlocks() {
		return List.of(BLOCK, ORE_BLOCK, DEEPSLATE_ORE_BLOCK);
	}
